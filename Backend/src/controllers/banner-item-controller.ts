...
//       const response = await BannerItemService.createBannerItem(request);
...
//       const response = await BannerItemService.getBannerItem(bannerId, itemId);
...
//       const response = await BannerItemService.updateBannerItem(bannerId, itemId, request);
...
//       const bannerId = parseInt(req.params.bannerId);
//       const itemId = parseInt(req.params.itemId);
//       const response = await BannerItemService.deleteBannerItem(bannerId, itemId);
