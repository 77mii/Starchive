...
async function main() {
  ...
  const bannerItems = [
    { banner_id: banner1.banner_id, item_id: createdItems[0].item_id, acquire_rate: 0.5 },
    { banner_id: banner1.banner_id, item_id: createdItems[1].item_id, acquire_rate: 0.3 },
    { banner_id: banner1.banner_id, item_id: createdItems[2].item_id, acquire_rate: 0.2 },
    { banner_id: banner2.banner_id, item_id: createdItems[3].item_id, acquire_rate: 0.5 },
    { banner_id: banner2.banner_id, item_id: createdItems[4].item_id, acquire_rate: 0.3 },
    { banner_id: banner2.banner_id, item_id: createdItems[5].item_id, acquire_rate: 0.2 },
  ];
