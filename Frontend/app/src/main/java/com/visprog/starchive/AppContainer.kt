...
class DefaultAppContainer(private val userDataStore: DataStore<Preferences>): AppContainer {
    ...
    private val bannerItemRetrofitService: BannerItemService by lazy {
        val retrofit = initRetrofit()
        retrofit.create(BannerItemService::class.java)
    }
    private val itemRetrofitService: ItemService by lazy {
        val retrofit = initRetrofit()
        retrofit.create(ItemService::class.java)
    }
    private val pityRetrofitService: PityService by lazy {
        val retrofit = initRetrofit()
    ...
    override val bannerItemRepository: BannerItemRepository by lazy {
        NetworkBannerItemRepository(bannerItemRetrofitService)
    }
    override val itemRepository: ItemRepository by lazy {
        NetworkItemRepository(itemRetrofitService)
    }
